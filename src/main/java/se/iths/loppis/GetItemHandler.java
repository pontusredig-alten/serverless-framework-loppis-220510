...
public class GetItemHandler implements RequestHandler<HttpRequest, HttpResponse> {

    @Override
    public HttpResponse handleRequest(HttpRequest httpRequest, Context context) {

        context.getLogger().log("HttpRequest send to GetItemHandler: " + httpRequest.toString());
        ...
        return new HttpResponse(fetchedItem);
    }
}
